...
import { User2, MailIcon, HomeIcon, PhoneCall, GraduationCap, Calendar, Briefcase, Phone } from 'lucide-react'
import { get } from "react-hook-form"

const infoData = [
    {
        icon: <User2 size={20} />,
        text: 'Arnab Chaudhuri',
    },
    {
    ...
    },
    {
        ...
        text: 'arnabchaudhuri2002@gmail.com',
    },
    {
        icon: <Calendar size={20} />,
        text: 'Born on 4 Oct, 2002',
    },
    {
    ...
    },
    {
        ...
        text: '49 Battala Bye Lane-1, Hindmotor, West Bengal, India.',
    },
...
const qualificationData = [
    {
        ...
        data: [
            {
                university: 'University of Engineering and Managment',
...
const skillData = [
    ...
    // fill imgPath with your tools images
    {
        title: 'tools',
        data: [
            {
        ...
        <div className="container mx-auto">
            ...
            <div className="flex flex-col xl:flex-row">
                ...
                <div className="hidden xl:flex flex-1 relative">
                    <DevImg containerStyles='bg-about_shape_light dark:bg-about_shape_dark w-[505px] h-[505px] bg-no-repeat relative' imgSrc='/about/' />
                </div>
                {/* tabs  */}
                                                    ...
                                                    return (
                                                        <div className="flex gap-x-8 group" key={index}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-base font font-medium">
                                                                    {years}
                                                                </div>
                                                            </div>
                                                        </div>
