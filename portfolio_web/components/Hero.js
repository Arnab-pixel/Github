            ...
            <div className="container mx-auto">
                <div className="flex justify-between gap-x-8">
                    ...
                    <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
                        ...
                        <h1 className="h1 mb-4">Hello, my name is Arnab Chaudhuri</h1>
                        ...
                        {/* socials */}
                        <Socials containerStyles="flex gap-x-6 mx-auto xl:mx-0" iconsStyles='text-foreground text-[22px] hover:text-slate-500 transition-all' />
                    </div>
                    {/* image */}
